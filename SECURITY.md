...
1. **GitHub Private Vulnerability Reporting** (preferred): Use the [Security Advisories](https://github.com/eriklieben/ErikLieben.FA.Results/security/advisories/new) feature to report privately.
